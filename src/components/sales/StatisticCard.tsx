...
const StatisticCard: React.FC<StatisticCardProps> = ({ value, label, icon, delay = 0, visible }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-purple-900/10 to-pink-900/10 border border-purple-500/10 rounded-xl p-6 flex flex-col items-center text-center hover:border-purple-500/30 transition-all duration-300 shadow-lg"
    >
