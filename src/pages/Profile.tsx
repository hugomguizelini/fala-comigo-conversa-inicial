    ...
    <DashboardLayout>
      <div className="p-6 space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-12">
          {/* Coluna da esquerda com informações do perfil */}
          <div className="md:col-span-4 space-y-6">
            <Card>
              ...
              <CardFooter className="flex flex-col gap-2 pt-2">
                <Button variant="outline" className="w-full">Ver Atividades</Button>
                <Button variant="outline" className="w-full">Histórico de Relatórios</Button>
              </CardFooter>
            </Card>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="pt-4">
                      ...
                      <p className="text-muted-foreground mb-4">Proteja sua conta com uma camada adicional de segurança.</p>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid gap-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <Label htmlFor="email-reports">Relatórios de desempenho</Label>
                          <p className="text-sm text-muted-foreground">
                            Receba relatórios semanais por email
                          </p>
                        </div>
                        <Button variant="outline" size="sm" disabled={!isEditing}>Ativar</Button>
                      </div>
